...
$parentid=$_SESSION["parentid"];
						...
						{ 
								...
								$gqquery ="SELECT  *  from client where userid in(select userid from userinfo where parentid=$departmentid) and clientname like '%".$clientname."%' ORDER BY id desc LIMIT ".$nowpage.","."$dbzz_bianma_pagenum";
								}
								else
								{
								if($parentid==-1)
								...
								$gqquery ="SELECT  *  from client WHERE userid in(select userid from userinfo where parentid=$departmentid) ORDER BY id desc LIMIT ".$nowpage.","."$dbzz_bianma_pagenum"; 
								}
					...
					if ($clientname<>"")
					{
						...
						$query0 ="SELECT id from client WHERE userid in(select userid from userinfo where parentid=$departmentid) and clientname like '%".$clientname."%'";
					}
					else
					{
						if($parentid==-1)
						...
						$query0 ="SELECT id from client WHERE userid in(select userid from userinfo where parentid=$departmentid)";
					}
