								...
								switch ($select_class) {
								    case "企业名称":
												if ($clientname<>"")
												{
													...
													$gqquery ="SELECT  *  from linkname where userid in(select userid from userinfo where parentid=$departmentid) and clientname like '%".$clientname."%' ORDER BY id desc LIMIT ".$nowpage.","."$dbzz_bianma_pagenum";
													}
													else
													{
														if($parentid==-1)
														...
														$gqquery ="SELECT  *  from linkname where userid in(select userid from userinfo where parentid=$departmentid)  ORDER BY id desc LIMIT ".$nowpage.","."$dbzz_bianma_pagenum"; 
														}
								        break;
								    case "联系人":
												if ($clientname<>"")
												{
													...
													$gqquery ="SELECT  *  from linkname where userid in(select userid from userinfo where parentid=$departmentid) and  name like '%".$clientname."%' ORDER BY id desc LIMIT ".$nowpage.","."$dbzz_bianma_pagenum";
													}
													else
													{
														if($parentid==-1)
								...
								switch ($select_class) {
								    case "企业名称":
												...
												{	
													...
													$query0 ="SELECT id from linkname where userid in(select userid from userinfo where parentid=$departmentid) and clientname like '%".$clientname."%' ";
													}
													else
													{
														if($parentid==-1)
														...
														$query0 ="SELECT id from linkname where userid in(select userid from userinfo where parentid=$departmentid) ";
														}
								        break;
								    case "联系人":
												if ($clientname<>"")
												{	
													...
													$query0 ="SELECT id from linkname where userid in(select userid from userinfo where parentid=$departmentid) and name like '%".$clientname."%'";
													}
													else
													{
														if($parentid==-1)
